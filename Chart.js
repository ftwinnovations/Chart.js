		...
		draw : function(){
			if (this.display){
				...
				if(this.pointLabel){
					...
					ctx.fillText(this.pointLabel, this.x, this.y);
				}
				...
				helpers.each(dataset.data,function(dataPoint,index){
					...
					if (helpers.isNumber(dataPoint)){
						...
						datasetObject.points.push(new this.PointClass({
							...
							label : dataPoint.label || data.labels[index],
							datasetLabel: dataset.label,
							pointLabel: dataPoint.pointLabel,   // This new feature added by Austin Butler 3/13/2015.  Allows text inside a bubble
